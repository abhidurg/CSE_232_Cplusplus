...
//returns 1 if num is even; returns 0 if num is odd
int parity(int num) {
  if (num % 2 == 0) {
    return 1;
  } else {
...
//creates a print-friendly string from a given vector input
...
//creates a print-friendly string from a given matrix input
